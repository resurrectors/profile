...
assets/
  ...
  shubham.jpg                    # hero headshot (400×400)
...
- **Headshot** → replace `assets/shubham.jpg` (keep it roughly square; ~400×400 is plenty)
- **Résumé** → replace `assets/Shubham_Patil_Resume.pdf` (keep the same filename so the download
  link keeps working)
